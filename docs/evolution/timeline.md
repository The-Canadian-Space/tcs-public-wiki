...
timeline
    ...
    2026 Q1 : Cost tracking infrastructure
...
**Early 2025** we shipped the first Daily Broadcast workflow. It was rough, but it worked: pull articles from SNAPI, route to Gemini, publish to WordPress. No cost tracking, no editorial pass, no fallbacks. Just the core loop.
...
**Late 2025** we got serious about cost visibility. Every token spent on OpenRouter gets logged. Every n8n execution gets tracked. The Cost Sentinel report tells us if we're trending up or down.
