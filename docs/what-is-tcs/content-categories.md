...
Every story we publish passes through a filter:

1. **Is it aerospace?** — If it involves launch, spaceflight, orbital mechanics, or space industry, it's on the table.
2. **Is it sourced?** — We pull from NASA, SpaceFlightNews API, RSS feeds, Wikipedia, and official announcements. No rumors without attribution.
3. **Does it matter?** — A funding round matters. A single tweet doesn't (unless it's from an official channel and affects the industry).
4. **Does it have a Canadian angle?** — Even in our daily broadcasts, we flag Canadian connections.

---

[Next: How We Think About The News →](editorial-philosophy.md){ .md-button .md-button--primary }
