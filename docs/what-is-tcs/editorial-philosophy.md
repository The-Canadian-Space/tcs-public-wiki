...
1. **Curation**: Robo Chris (an AI persona) scans NASA feeds, SpaceFlightNews API, RSS, and launch databases. It pulls the most relevant stories.
2. **Authoring**: An LLM (usually Google Gemini) drafts the article using structured author guidelines that enforce accuracy, tone, and sourcing.
...
[Next: How it works →](../how-it-works/index.md){ .md-button .md-button--primary }
